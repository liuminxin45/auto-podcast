...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  newsnowGetStatus: () => ipcRenderer.invoke('newsnow:getStatus'),
  newsnowSync: (options) => ipcRenderer.invoke('newsnow:sync', options),
  newsnowSetup: () => ipcRenderer.invoke('newsnow:setup'),
  newsnowBuild: () => ipcRenderer.invoke('newsnow:build'),
  newsnowStart: (options) => ipcRenderer.invoke('newsnow:start', options),
  newsnowStop: () => ipcRenderer.invoke('newsnow:stop'),
  onNewsnowLog: (callback) => ipcRenderer.on('newsnow:log', (_, data) => callback(data)),
  onNewsnowStatus: (callback) => ipcRenderer.on('newsnow:status', (_, data) => callback(data)),
