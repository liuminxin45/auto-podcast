...
const PLATFORM_OPTIONS = [
  { id: 'xiaoyuzhou', label: '小宇宙', icon: '🎧', desc: '中文播客首选平台' },
  { id: 'apple', label: 'Apple Podcasts', icon: '🍎', desc: '全球最大播客平台' },
  { id: 'spotify', label: 'Spotify', icon: '🎵', desc: '音乐与播客一体' },
  { id: 'ximalaya', label: '喜马拉雅', icon: '🏔️', desc: '国内音频内容平台' },
  { id: 'wechat', label: '微信听书', icon: '💬', desc: '微信生态内容分发' },
]
