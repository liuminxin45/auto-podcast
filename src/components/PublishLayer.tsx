...
const CONTENT_SUGGESTIONS: AgentSuggestion[] = [
  {
    id: 'cs1',
    title: '标题可以更抓人',
...
const DISTRIBUTION_SUGGESTIONS: AgentSuggestion[] = [
  {
    id: 'ds1',
    title: '发布时间建议',
...
const RISK_SUGGESTIONS: AgentSuggestion[] = [
  {
    id: 'rs1',
    title: '内容安全检查通过',
  ...
  const doPublish = useCallback((method: 'smart' | 'quick') => {
    ...
    const interval = setInterval(() => {
      ...
      if (progress >= 100) {
        ...
        // Transition to success after a beat
        setTimeout(() => {
